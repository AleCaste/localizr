            ...
            var step2 = function() {
              co(function *() {
                ...
                if (cah_i18n_server!=null) {
                  ...
                  else if (cah_i18n_server.type==='redis')  data_cached = JSON.parse(yield cah_i18n_server.get(that.file));
                  if (data_cached!=null) {
                    //console.log('IN CACHE [server] view!!! (lru)', data_cached);
                ...
                if (data_cached==null) {
                  ...
                  else if (cah_i18n_server!=null && cah_i18n_server.type==='redis')  yield cah_i18n_server.set(that.file, JSON.stringify(data_cached));
                  data_file = data_cached;
                  step3();
                }
              }).catch(function(err) {
              ...
              co(function *() {
                ...
                if (file_globals!=null) {
                  ...
                  if (cah_i18n_server!=null) {
                    ...
                    else if (cah_i18n_server.type==='redis')  data_cached = JSON.parse(yield cah_i18n_server.get(file_globals));
                    if (data_cached!=null) {
                      //console.log('IN CACHE [server] globals !!! (lru)', data_cached);
                  ...
                  if (data_cached==null) {
                    ...
                    else if (cah_i18n_server!=null && cah_i18n_server.type==='redis')  yield cah_i18n_server.set(file_globals, JSON.stringify(data_cached));
                    data_file_globals = data_cached;
                    step2();
                  }
                } else step2();
